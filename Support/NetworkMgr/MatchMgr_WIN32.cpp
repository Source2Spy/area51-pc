//==============================================================================
//
// MatchMgr_WIN32.cpp - Matchup manager interface functions.
//
//==============================================================================
//
...
static char* s_pAuth = 0;
static char* s_pChallenge = 0;
static u64   s_PID = 0;
...
void PersDataReadCallback(int localid, int profileid, persisttype_t type, int index, int success, time_t modified, char *data, int len, void *instance)
{
    /* we copy it off, instead of reading directly, since the data may not be aligned correctly */
...
void match_mgr::UpdateState( f32 DeltaTime)
{
    ...
    case MATCH_GET_MESSAGES:
        ...
        {
            // No download in progress - MOTD was already processed (or never needed).
            // Skip directly to auth done.
